 ...
 * @method static \Spatie\Activitylog\Support\ActivityLogger useLog(\BackedEnum|string|null $logName)
 * @method static \Spatie\Activitylog\Support\ActivityLogger inLog(\BackedEnum|string|null $logName)
