...
import { n as euro } from "./format--h649JLD.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-b4bc6a8a><header class="compare-head" data-v-b4bc6a8a><div class="compare-head__copy" data-v-b4bc6a8a><h1 id="vergleich-title" class="h1" tabindex="-1" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(title.value)} `);
			if (__props.demo) _push(`<span class="badge demo-note" data-v-b4bc6a8a>Demodaten</span>`);
			else _push(`<!---->`);
			_push(`</h1>`);
			if (count.value > 0) {
				_push(`<div class="compare-head__meta" data-v-b4bc6a8a><span class="small num muted" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(count.value)} von ${(0, server_renderer_exports.ssrInterpolate)(__props.cap)} Felgen</span>`);
			...
			if (__props.demo) _push(`<p class="micro quiet" data-v-b4bc6a8a>Beispielsortiment – Preise und Bestände sind Beispielwerte.</p>`);
			else _push(`<!---->`);
			_push(`</div>`);
			if (count.value > 0) _push(`<label class="check compare-head__toggle" data-v-b4bc6a8a><input${(0, server_renderer_exports.ssrIncludeBooleanAttr)(Array.isArray(diff.value) ? (0, server_renderer_exports.ssrLooseContain)(diff.value, null) : diff.value) ? " checked" : ""} type="checkbox" aria-controls="vergleich-tabelle" data-v-b4bc6a8a> Unterschiede hervorheben </label>`);
			else _push(`<!---->`);
			_push(`</header>`);
			if (count.value === 0) {
				_push(`<div class="empty" data-v-b4bc6a8a><p class="empty__title" data-v-b4bc6a8a>Noch keine Felgen im Vergleich.</p><p class="empty__text" data-v-b4bc6a8a>Setz auf einer Felge das Häkchen „Vergleichen“ – bis zu vier Felgen nebeneinander.</p>`);
				_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
					href: "/felgen",
				...
				if (__props.missing > 0) {
					_push(`<div class="notice compare-notice compare-table" role="status" data-v-b4bc6a8a>`);
					_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
						name: "info",
						size: 20
					}, null, _parent));
					_push(`<p data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(__props.missing === 1 ? "Eine Felge aus deinem Vergleich ist nicht mehr im Sortiment und wurde entfernt." : `${__props.missing} Felgen aus deinem Vergleich sind nicht mehr im Sortiment und wurden entfernt.`)}</p></div>`);
				} else _push(`<!---->`);
				if (count.value === 1) {
					_push(`<div class="${(0, server_renderer_exports.ssrRenderClass)([{ "compare-table": __props.missing === 0 }, "notice compare-notice"])}" data-v-b4bc6a8a>`);
					_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
						name: "info",
						size: 20
					}, null, _parent));
					_push(`<p data-v-b4bc6a8a> Füge eine zweite Felge hinzu, um zu vergleichen. `);
					_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
						href: "/felgen",
						class: "link",
						prefetch: ""
				...
				}, "compare"])}" style="${(0, server_renderer_exports.ssrRenderStyle)({ "--n": count.value })}" role="table" aria-labelledby="vergleich-title"${(0, server_renderer_exports.ssrRenderAttr)("data-diff", diff.value ? "on" : void 0)} data-v-b4bc6a8a><div class="compare__row compare__head" role="row" data-v-b4bc6a8a><div class="compare__label" role="cell" data-v-b4bc6a8a></div><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(__props.items, (item, i) => {
					_push(`<div class="compare__cell" role="cell" data-v-b4bc6a8a><span class="compare__img" data-v-b4bc6a8a>`);
					...
					_push(`</span><span class="small quiet" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.brandName)}</span><span class="h4" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.modelName)}</span><span class="small muted" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.finishName)}</span><span class="body num compare__price" data-v-b4bc6a8a>ab ${(0, server_renderer_exports.ssrInterpolate)(perWheel(item))} pro Felge</span><span class="micro quiet" data-v-b4bc6a8a>inkl. MwSt., zzgl. Versand</span>`);
					...
					_push(`<button class="icon-btn compare__remove" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-label", `${item.brandName} ${item.modelName} aus dem Vergleich entfernen`)} data-v-b4bc6a8a>`);
					_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
						name: "close",
						size: 16
					}, null, _parent));
				...
				_push(`<!--]--></div><div class="compare__row compare__stick" role="row" data-v-b4bc6a8a><div class="compare__label" role="columnheader" data-v-b4bc6a8a><span class="label" data-v-b4bc6a8a>Felge</span></div><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(__props.items, (item) => {
					_push(`<div${(0, server_renderer_exports.ssrRenderAttr)("id", columnId(item))} class="compare__cell" role="columnheader" data-v-b4bc6a8a><span class="compare__img" data-v-b4bc6a8a>`);
					if (item.image) _push((0, server_renderer_exports.ssrRenderComponent)(Picture_default, {
						image: item.image,
						alt: "",
						sizes: "48px"
					...
					_push(`</span><span class="compare__stick-name" data-v-b4bc6a8a><span class="micro quiet" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.brandName)}</span><span data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.modelName)}</span></span>`);
				...
				(0, server_renderer_exports.ssrRenderList)(groups.value, (group) => {
					_push(`<!--[--><div class="compare__row" role="row" data-v-b4bc6a8a><div class="compare__label compare__group" role="rowheader"${(0, server_renderer_exports.ssrRenderAttr)("aria-colspan", count.value + 1)} data-v-b4bc6a8a><span class="label" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(group.label)}</span></div></div><!--[-->`);
					(0, server_renderer_exports.ssrRenderList)(group.rows, (r) => {
						_push(`<div class="${(0, server_renderer_exports.ssrRenderClass)([{ "compare__row--same": r.same }, "compare__row compare__row--data"])}" role="row" data-v-b4bc6a8a><div class="compare__label" role="rowheader" data-v-b4bc6a8a><span class="label" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(r.label)}</span>`);
						...
						(0, server_renderer_exports.ssrRenderList)(r.cells, (cell, i) => {
							...
							}, "compare__cell"])}" role="cell"${(0, server_renderer_exports.ssrRenderAttr)("aria-describedby", headerIds.value[i])} data-v-b4bc6a8a>`);
							if (r.kind === "verdict") {
								_push(`<!--[-->`);
								...
								else _push(`<span class="small muted" data-v-b4bc6a8a>–</span>`);
								if (cell.verdict && cell.verdict.reason) _push(`<span class="small muted compare__reason" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(cell.verdict.reason)}</span>`);
								else _push(`<!---->`);
								_push(`<!--]-->`);
							} else if (r.kind === "lines") {
								_push(`<ul class="compare__list" data-v-b4bc6a8a><!--[-->`);
								(0, server_renderer_exports.ssrRenderList)(cell.lines, (line) => {
									_push(`<li data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(line)}</li>`);
								});
								_push(`<!--]--></ul>`);
				...
				_push(`<!--]--><div class="compare__row compare__actions" role="row" data-v-b4bc6a8a><div class="compare__label" role="cell" data-v-b4bc6a8a></div><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(__props.items, (item) => {
					_push(`<div class="compare__cell" role="cell" data-v-b4bc6a8a>`);
					if (item.buy.kind === "basket") _push(`<!--[--><form class="compare__buy" data-v-b4bc6a8a><button class="btn btn--primary btn--block" type="submit"${(0, server_renderer_exports.ssrRenderAttr)("aria-busy", adding.value === item.buy.configId ? "true" : void 0)} data-v-b4bc6a8a>In den Warenkorb</button></form><span class="small muted" data-v-b4bc6a8a>${(0, server_renderer_exports.ssrInterpolate)(item.buy.sizeLabel)} · für deinen ${(0, server_renderer_exports.ssrInterpolate)(vehicle.value?.short)}</span><!--]-->`);
						...
						_push(`<!--[--><span class="small muted" data-v-b4bc6a8a>Nicht freigegeben für deinen ${(0, server_renderer_exports.ssrInterpolate)(vehicle.value?.short)}</span>`);
						_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
...
var CompareTable_default = /*#__PURE__*/ _plugin_vue_export_helper_default(CompareTable_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b4bc6a8a"]]);
//#endregion
