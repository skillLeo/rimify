...
import { a as Picture_default, i as WheelOutline_default, o as ListRow_default, s as BottomSheet_default } from "./useShortcuts-DQyB2dUf.js";
import { t as DocFacsimile_default } from "./DocFacsimile-D9bZK4Sy.js";
import { n as VerdictBadge_default } from "./rimify-CDsi0i0x.js";
import { n as euro, r as felgen, t as decimal } from "./format--h649JLD.js";
...
import { a as komplettrad_illustration_default, c as HERO_SIZES_PHONE, d as heroScene, f as rollStyle, i as rimFactsOf, l as PHONE_LAYOUT, n as TITLE, p as BrandWall_default, r as RimCode_default, t as DESCRIPTION, u as frameStyle } from "./meta-z-VqHG5m.js";
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			(0, server_renderer_exports.ssrRenderVNode)(_push, (0, vue_exports.createVNode)((0, vue_exports.resolveDynamicComponent)(named.value ? (0, vue_exports.unref)(link_default) : "div"), {
				...
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<span class="hero-studio" aria-hidden="true" data-v-4f63cd29${_scopeId}></span>`);
						if (photo.value) {
							_push(`<span class="${(0, server_renderer_exports.ssrRenderClass)([{ "hero-frame__roll--rolling": scene.value.roll !== null }, "hero-frame__roll"])}" style="${(0, server_renderer_exports.ssrRenderStyle)(pictureStyle.value)}" data-v-4f63cd29${_scopeId}>`);
							if (scene.value.shadow) _push(`<span class="hero-contact" aria-hidden="true" data-v-4f63cd29${_scopeId}></span>`);
							else _push(`<!---->`);
							_push(`<span class="hero-frame__spin" data-v-4f63cd29${_scopeId}>`);
							...
							_push(`<span class="hero-frame__outline" aria-hidden="true" data-v-4f63cd29${_scopeId}>`);
			...
			_push(`<p class="small num muted hero-mobile__spec" data-v-4f63cd29>${(0, server_renderer_exports.ssrInterpolate)(__props.product.facts.specLine)}`);
			if (kba.value) _push(`<span class="visually-hidden" data-v-4f63cd29> · ${(0, server_renderer_exports.ssrInterpolate)(kba.value.label)} ${(0, server_renderer_exports.ssrInterpolate)(kba.value.value)}</span>`);
			else _push(`<!---->`);
			_push(`</p>`);
			if (named.value) _push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
				...
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<span class="small hero-mobile__name" data-v-4f63cd29${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.product.brand)} ${(0, server_renderer_exports.ssrInterpolate)(__props.product.name)} · ${(0, server_renderer_exports.ssrInterpolate)(__props.product.finish)}</span><span class="small num muted" data-v-4f63cd29${_scopeId}>ab ${(0, server_renderer_exports.ssrInterpolate)(perWheel.value)} · pro Felge</span>`);
					else return [(0, vue_exports.createVNode)("span", { class: "small hero-mobile__name" }, (0, vue_exports.toDisplayString)(__props.product.brand) + " " + (0, vue_exports.toDisplayString)(__props.product.name) + " · " + (0, vue_exports.toDisplayString)(__props.product.finish), 1), (0, vue_exports.createVNode)("span", { class: "small num muted" }, "ab " + (0, vue_exports.toDisplayString)(perWheel.value) + " · pro Felge", 1)];
				}),
				_: 1
			}, _parent));
			else _push(`<!---->`);
			if (photo.value) _push(`<p class="micro quiet hero-mobile__shown" data-v-4f63cd29>${(0, server_renderer_exports.ssrInterpolate)(CAPTION)}</p>`);
			else _push(`<p class="micro quiet hero-mobile__symbolic" data-v-4f63cd29>${(0, server_renderer_exports.ssrInterpolate)(SYMBOLIC)}</p>`);
			if ((0, vue_exports.unref)(page).props.demo) _push(`<p class="micro quiet demo-note" data-v-4f63cd29>${(0, server_renderer_exports.ssrInterpolate)(DEMO)}</p>`);
			else _push(`<!---->`);
			_push(`</div>`);
		};
	}
...
var HeroFrame_default = /*#__PURE__*/ _plugin_vue_export_helper_default(HeroFrame_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-4f63cd29"]]);
//#endregion
...
var VehiclePanel_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue_exports.defineComponent)({
	...
	setup(__props) {
		...
		*/
		...
		const scanLoader = (/* @__PURE__ */ Object.assign({ "../../Home/DocumentScan.vue": () => import("./DocumentScan-Bap-02t7.js").then((n) => n.n) }))["../../Home/DocumentScan.vue"];
