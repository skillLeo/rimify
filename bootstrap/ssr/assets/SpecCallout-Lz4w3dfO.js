...
import { A as useEventListener, C as useId, H as createContext, M as useVModel, S as Presence_default, T as useForwardExpose, b as Primitive, z as isNullish } from "./Dialog-DGnwH3Iu.js";
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({
				...
				"aria-hidden": "true"
			}, _attrs))} data-v-4c0f5ef9><svg class="callout__line"${(0, server_renderer_exports.ssrRenderAttr)("viewBox", `0 0 ${width.value} 100`)} preserveAspectRatio="none" focusable="false" style="${(0, server_renderer_exports.ssrRenderStyle)({ "--callout-weight": __props.weight })}" data-v-4c0f5ef9>`);
			if (__props.ring) _push(`<circle class="callout__ring"${(0, server_renderer_exports.ssrRenderAttr)("cx", ux(__props.ring.cx))}${(0, server_renderer_exports.ssrRenderAttr)("cy", __props.ring.cy)}${(0, server_renderer_exports.ssrRenderAttr)("r", __props.ring.r)} pathLength="60" data-v-4c0f5ef9></circle>`);
			else _push(`<!---->`);
			_push(`<path class="callout__leader"${(0, server_renderer_exports.ssrRenderAttr)("d", d.value)} pathLength="1" data-v-4c0f5ef9></path><circle class="callout__dot"${(0, server_renderer_exports.ssrRenderAttr)("cx", end.value.x)}${(0, server_renderer_exports.ssrRenderAttr)("cy", end.value.y)}${(0, server_renderer_exports.ssrRenderAttr)("r", dot.value)} data-v-4c0f5ef9></circle></svg><div class="${(0, server_renderer_exports.ssrRenderClass)([__props.side ? `callout--${__props.side}` : void 0, "callout"])}" style="${(0, server_renderer_exports.ssrRenderStyle)(boxStyle.value)}" data-v-4c0f5ef9><span class="callout__label" data-v-4c0f5ef9>${(0, server_renderer_exports.ssrInterpolate)(__props.label)}</span><span class="callout__value" data-v-4c0f5ef9>${(0, server_renderer_exports.ssrInterpolate)(__props.value)}</span>`);
			if (__props.note) _push(`<span class="callout__note" data-v-4c0f5ef9>${(0, server_renderer_exports.ssrInterpolate)(__props.note)}</span>`);
			else _push(`<!---->`);
			_push(`</div></div>`);
		};
	}
...
var SpecCallout_default = /*#__PURE__*/ _plugin_vue_export_helper_default(SpecCallout_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-4c0f5ef9"]]);
//#endregion
