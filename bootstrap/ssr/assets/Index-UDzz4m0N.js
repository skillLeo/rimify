...
import { t as Icon_default$1 } from "./Icon-CPN9Jl2j.js";
import { a as DialogOverlay_default, n as DialogTitle_default, r as DialogPortal_default, s as DialogContent_default, v as DialogClose_default, y as DialogRoot_default } from "./Dialog-DGnwH3Iu.js";
...
import { t as ProductPhoto_default } from "./ProductPhoto--eXIebWP.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<section class="section-dense" data-v-9ab3fcd5><div class="wrap" data-v-9ab3fcd5><nav class="pdp__crumbs t-small" aria-label="Brotkrumen" data-v-9ab3fcd5>`);
			...
			_push(`<span aria-hidden="true" data-v-9ab3fcd5>/</span>`);
			...
			_push(`<span aria-hidden="true" data-v-9ab3fcd5>/</span><span aria-current="page" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(__props.product.brandName)} ${(0, server_renderer_exports.ssrInterpolate)(__props.product.modelName)}</span></nav><div class="pdp" data-v-9ab3fcd5><div class="pdp__gallery" data-v-9ab3fcd5><div class="well pdp__well" data-v-9ab3fcd5>`);
			if (shot.value) {
				_push(`<button type="button" class="pdp__zoom" aria-haspopup="dialog"${(0, server_renderer_exports.ssrRenderAttr)("aria-label", `Foto vergrößern: ${shotAlt.value}`)} data-v-9ab3fcd5>`);
			...
			if (shots.value.length > 1) {
				_push(`<div class="pdp__thumbs" role="group" aria-label="Ansichten" data-v-9ab3fcd5><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(shots.value, (view, i) => {
					_push(`<button type="button" class="pdp__thumb"${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", i === shotIndex.value)}${(0, server_renderer_exports.ssrRenderAttr)("aria-label", view.label)} data-v-9ab3fcd5>`);
					_push((0, server_renderer_exports.ssrRenderComponent)(Picture_default, {
						image: view,
						alt: "",
						sizes: "72px",
						...
						default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
							if (_push) {
								...
								_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(DialogContent_default), {
									...
									default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
										if (_push) {
											_push(`<div class="dialog__head" data-v-9ab3fcd5${_scopeId}>`);
											...
											_push(`</div><div class="pdp-zoom__frame" data-v-9ab3fcd5${_scopeId}>`);
			...
			_push(`</div><div class="pdp__buy" data-v-9ab3fcd5><h1 class="t-h1" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(__props.product.brandName)} ${(0, server_renderer_exports.ssrInterpolate)(__props.product.modelName)}</h1>`);
			if (__props.product.typeDesignation) _push(`<p class="data pdp__type" data-v-9ab3fcd5>Typ ${(0, server_renderer_exports.ssrInterpolate)(__props.product.typeDesignation)}</p>`);
			else _push(`<!---->`);
			if (__props.product.rating !== null && __props.product.ratingCount > 0) _push(`<p class="stars pdp__rating" data-v-9ab3fcd5><span class="stars__glyph" aria-hidden="true" data-v-9ab3fcd5>★</span><span class="tabular" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(__props.product.ratingLabel)}</span></p>`);
			else _push(`<!---->`);
			_push(`<div class="pdp__block" data-v-9ab3fcd5><span class="micro" data-v-9ab3fcd5>Farbe · ${(0, server_renderer_exports.ssrInterpolate)(finish.value?.name)}</span><div class="pdp__swatches" data-v-9ab3fcd5><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)(__props.finishes, (item) => {
				_push(`<button class="${(0, server_renderer_exports.ssrRenderClass)([{ "pdp__swatch--on": item.id === (0, vue_exports.unref)(config).finishId.value }, "pdp__swatch"])}" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", item.id === (0, vue_exports.unref)(config).finishId.value)} data-v-9ab3fcd5><span class="pdp__dot" style="${(0, server_renderer_exports.ssrRenderStyle)(item.hex ? { "--swatch": item.hex } : void 0)}" data-v-9ab3fcd5></span> ${(0, server_renderer_exports.ssrInterpolate)(item.name)}</button>`);
			});
			_push(`<!--]--></div></div><div id="groessen" class="pdp__block" data-v-9ab3fcd5><span class="micro" data-v-9ab3fcd5>Durchmesser (Zoll)</span><div class="chip-row pdp__chips" data-v-9ab3fcd5><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)((0, vue_exports.unref)(config).sizes.value, (size) => {
				...
				}, "chip"])}" type="button"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(size.blocked) ? " disabled" : ""}${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", selected.value?.id === size.config.id)}${(0, server_renderer_exports.ssrRenderAttr)("title", size.reason ?? void 0)} data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(size.label)}</button>`);
			});
			_push(`<!--]--></div>`);
			if ((0, vue_exports.unref)(config).sizes.value.some((s) => s.blocked)) _push(`<p class="t-small quiet pdp__note" data-v-9ab3fcd5> Durchgestrichene Größen sind für dein Fahrzeug nicht freigegeben. </p>`);
			else _push(`<!---->`);
			_push(`</div>`);
			...
			_push(`<div class="pdp__price" data-v-9ab3fcd5><p class="price price--lg" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value?.price ?? (0, vue_exports.unref)(config).fromPrice.value)}</p><p class="price-note" data-v-9ab3fcd5>für 4 Felgen, inkl. MwSt., zzgl. Versand</p><span class="${(0, server_renderer_exports.ssrRenderClass)([stockTone.value, "tag pdp__stock"])}" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(stockLabel.value)}</span>`);
			if (__props.demo) _push(`<p class="t-small pdp__demo" data-v-9ab3fcd5> Beispielsortiment: Diese Felge kannst du dir ansehen und in den Warenkorb legen, bestellen kannst du sie noch nicht. </p>`);
			else _push(`<!---->`);
			_push(`</div><div id="felgen-kaufen" data-v-9ab3fcd5><button class="btn btn--primary btn--block btn--lg pdp__add" type="button"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(!canBuy.value || (0, vue_exports.unref)(basket).processing) ? " disabled" : ""} data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(buyLabel.value)}</button></div></div></div>`);
			...
			if (selected.value) {
				_push(`<section class="pdp__specs" aria-labelledby="pdp-specs" data-v-9ab3fcd5><h2 id="pdp-specs" class="t-h2" data-v-9ab3fcd5>Felgendetails</h2><p class="t-small quiet pdp__specs-for" data-v-9ab3fcd5>Für ${(0, server_renderer_exports.ssrInterpolate)(selected.value.fullLabel)}</p><dl class="spec" data-v-9ab3fcd5><div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Größe</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.sizeLabel)}</dd></div><div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Lochkreis</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.boltPattern)}</dd></div><div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Mittenlochbohrung</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.centreBore)}</dd></div><div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Einpresstiefe (ET)</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.etMm)} mm</dd></div>`);
				if (weight.value) _push(`<div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Gewicht pro Felge</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(weight.value)}</dd></div>`);
				else _push(`<!---->`);
				if (maxLoad.value) _push(`<div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Traglast</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(maxLoad.value)}</dd></div>`);
				else _push(`<!---->`);
				if (selected.value.kbaNumber) _push(`<div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>KBA-Nummer</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.kbaNumber)}</dd></div>`);
				else _push(`<!---->`);
				_push(`<div class="spec__row" data-v-9ab3fcd5><dt data-v-9ab3fcd5>Artikelnummer</dt><dd class="t-mono" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.sku)}</dd></div></dl>`);
				if (__props.product.descriptionDe) _push(`<p class="t-body pdp__desc" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(__props.product.descriptionDe)}</p>`);
				else _push(`<!---->`);
				_push(`</section>`);
			} else _push(`<!---->`);
			_push(`</div></section>`);
			if (!buyVisible.value && selected.value) _push(`<div class="stickybar pdp__sticky" data-v-9ab3fcd5><div class="pdp__sticky-price" data-v-9ab3fcd5><p class="price" data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(selected.value.price)}</p><p class="price-note" data-v-9ab3fcd5>für 4 Felgen, inkl. MwSt., zzgl. Versand</p></div><button class="btn btn--primary pdp__sticky-btn" type="button"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(!canBuy.value || (0, vue_exports.unref)(basket).processing) ? " disabled" : ""} data-v-9ab3fcd5>${(0, server_renderer_exports.ssrInterpolate)(buyLabel.value)}</button></div>`);
			else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Index_default = /*#__PURE__*/ _plugin_vue_export_helper_default(Index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-9ab3fcd5"]]);
//#endregion
