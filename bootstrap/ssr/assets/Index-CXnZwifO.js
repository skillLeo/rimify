	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<section class="section-dense" data-v-b741c7dd><div class="wrap rec" data-v-b741c7dd><nav class="rec__nav" aria-label="Rechtliches" data-v-b741c7dd><!--[-->`);
			...
			_push(`<!--]--></nav><article class="rec__body" data-v-b741c7dd><h1 class="t-h1" data-v-b741c7dd>${(0, server_renderer_exports.ssrInterpolate)(title.value)}</h1><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)(blocks.value, (block) => {
				_push(`<div class="rec__block" data-v-b741c7dd>`);
				if (block.heading) _push(`<h2 class="t-h3" data-v-b741c7dd>${(0, server_renderer_exports.ssrInterpolate)(block.heading)}</h2>`);
				else _push(`<!---->`);
				_push(`<p class="${(0, server_renderer_exports.ssrRenderClass)([{ "rec__placeholder": block.placeholder }, "t-body"])}" data-v-b741c7dd>${(0, server_renderer_exports.ssrInterpolate)(block.text)}</p></div>`);
			});
			_push(`<!--]-->`);
			if (blocks.value.length === 0) _push(`<p class="t-body rec__placeholder" data-v-b741c7dd> Für diesen Abschnitt liegt noch kein Text vor. </p>`);
			else _push(`<!---->`);
...
var Index_default = /*#__PURE__*/ _plugin_vue_export_helper_default(Index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-b741c7dd"]]);
//#endregion
