import { i as usePage, n as link_default, r as useForm, s as vue_exports } from "../ssr.js";
import { n as server_renderer_exports, t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-CwXNU_Ma.js";
import { c as Svg_default, o as docSVG } from "./art-DxGr5VAf.js";
...
var _sfc_setup$1 = DocFacsimile_vue_vue_type_script_setup_true_lang_default.setup;
...
var VehicleSelector_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue_exports.defineComponent)({
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: ["vsel", { "vsel--compact": __props.compact }] }, _attrs))} data-v-5f83224e><section class="vsel__col" aria-labelledby="vsel-drill-title" data-v-5f83224e><div class="vsel__head" data-v-5f83224e>`);
			if (level.value !== "make") {
				_push(`<button class="vsel__back" type="button" data-v-5f83224e>`);
			...
			_push(`<h3 id="vsel-drill-title" class="t-h3 vsel__title" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)(stepLabel.value)}</h3></div><label class="visually-hidden"${(0, server_renderer_exports.ssrRenderAttr)("for", `vsel-q-${__props.basePath}`)} data-v-5f83224e>Marke oder Modell suchen</label><div class="vsel__search" data-v-5f83224e>`);
			_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
				name: "search",
				size: 20
			}, null, _parent));
			_push(`<input${(0, server_renderer_exports.ssrRenderAttr)("id", `vsel-q-${__props.basePath}`)}${(0, server_renderer_exports.ssrRenderAttr)("value", query.value)} class="field vsel__input" type="search" placeholder="Suchen" autocomplete="off" data-v-5f83224e></div><div class="row-list vsel__rows" data-v-5f83224e><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)(rows.value, (row) => {
				_push(`<button class="row-item" type="button"${(0, server_renderer_exports.ssrIncludeBooleanAttr)((0, vue_exports.unref)(choice).processing) ? " disabled" : ""} data-v-5f83224e><span class="vsel__label" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)(row.label)} `);
				if (row.blocked) _push(`<span class="tag tag--unknown vsel__flag" data-v-5f83224e> Daten unvollständig </span>`);
				else _push(`<!---->`);
				_push(`</span><span class="data vsel__note" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)(row.note)}</span></button>`);
			});
			_push(`<!--]-->`);
			if (rows.value.length === 0) _push(`<p class="quiet vsel__empty" data-v-5f83224e> Kein Treffer. Prüfe die Schreibweise oder nutze die Schlüsselnummern. </p>`);
			else _push(`<!---->`);
			_push(`</div></section><div class="vsel__divider" aria-hidden="true" data-v-5f83224e><span data-v-5f83224e>oder</span></div><section class="vsel__col vsel__col--keys" aria-labelledby="vsel-keys-title" data-v-5f83224e><h3 id="vsel-keys-title" class="t-h3 vsel__title" data-v-5f83224e>Mit Schlüsselnummern</h3><form data-v-5f83224e><div class="vsel__keys" data-v-5f83224e><div data-v-5f83224e><label class="field-label"${(0, server_renderer_exports.ssrRenderAttr)("for", `hsn-${__props.basePath}`)} data-v-5f83224e>HSN</label><input${(0, server_renderer_exports.ssrRenderAttr)("id", `hsn-${__props.basePath}`)} class="${(0, server_renderer_exports.ssrRenderClass)([{ "field--error": (0, vue_exports.unref)(keys).errors.hsn }, "field field--key"])}"${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(keys).hsn)} inputmode="numeric" maxlength="4" autocomplete="off" enterkeyhint="next" placeholder="0005"${(0, server_renderer_exports.ssrRenderAttr)("aria-invalid", (0, vue_exports.unref)(keys).errors.hsn ? "true" : void 0)} data-v-5f83224e></div><div data-v-5f83224e><label class="field-label"${(0, server_renderer_exports.ssrRenderAttr)("for", `tsn-${__props.basePath}`)} data-v-5f83224e>TSN</label><input${(0, server_renderer_exports.ssrRenderAttr)("id", `tsn-${__props.basePath}`)} class="${(0, server_renderer_exports.ssrRenderClass)([{ "field--error": (0, vue_exports.unref)(keys).errors.tsn }, "field field--key"])}"${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(keys).tsn)} maxlength="3" autocomplete="off" enterkeyhint="go" placeholder="582"${(0, server_renderer_exports.ssrRenderAttr)("aria-invalid", (0, vue_exports.unref)(keys).errors.tsn ? "true" : void 0)} data-v-5f83224e></div></div><span class="field-error" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(keys).errors.hsn ?? (0, vue_exports.unref)(keys).errors.tsn ?? "")}</span><p class="field-help" data-v-5f83224e> Beide stehen in deiner Zulassungsbescheinigung Teil I – die HSN in Feld 2.1, die TSN in Feld 2.2. <button class="vsel__helplink" type="button" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)(helpOpen.value ? "Abbildung ausblenden" : "Abbildung zeigen")}</button></p><button class="btn btn--primary btn--block vsel__go" type="submit"${(0, server_renderer_exports.ssrIncludeBooleanAttr)((0, vue_exports.unref)(keys).processing) ? " disabled" : ""} data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(keys).processing ? "Wird geprüft …" : "Fahrzeug wählen")}</button></form>`);
			if (lookup.value?.status === "ambiguous" && lookup.value.distinction) {
				_push(`<div class="vsel__chooser" data-v-5f83224e><p class="t-h3 vsel__chooser-title" data-v-5f83224e> Zu dieser Schlüsselnummer gibt es mehrere Varianten. </p>`);
				if (lookup.value.distinction.indistinguishable) _push(`<p class="quiet vsel__chooser-note" data-v-5f83224e> Die Varianten unterscheiden sich in keinem Feld, das wir anzeigen können. Die VSN aus deinem Fahrzeugschein hilft weiter. </p>`);
				else _push(`<!---->`);
				_push(`<!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(lookup.value.distinction.rows, (row) => {
					_push(`<button class="vsel__candidate" type="button" data-v-5f83224e><span class="vsel__candidate-text" data-v-5f83224e><span class="vsel__candidate-name" data-v-5f83224e>${(0, server_renderer_exports.ssrInterpolate)(row.label)}</span><span class="data vsel__candidate-values" data-v-5f83224e><!--[-->`);
					...
					_push(`</span></span><span class="btn btn--secondary btn--sm vsel__candidate-cta" data-v-5f83224e>Das ist meins</span></button>`);
				});
				_push(`<!--]--></div>`);
			} else if (lookup.value?.status === "not_found") {
				_push(`<div class="vsel__miss" data-v-5f83224e><p class="vsel__miss-title" data-v-5f83224e>`);
				_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
					name: "warning",
					size: 20
				}, null, _parent));
				_push(` Zu dieser Kombination haben wir kein Fahrzeug gefunden. </p><div class="vsel__miss-actions" data-v-5f83224e><button class="btn btn--secondary btn--sm" type="button" data-v-5f83224e> Schlüsselnummern prüfen </button>`);
				...
				_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
					...
					default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
						if (_push) _push(`Daten an RIMIFY senden`);
						else return [(0, vue_exports.createTextVNode)("Daten an RIMIFY senden")];
					}),
					_: 1
				}, _parent));
				_push(`</div></div>`);
			...
			if (helpOpen.value) {
				_push(`<div class="vsel__doc" data-v-5f83224e><div class="vsel__toggle" role="group" aria-label="Fahrzeugschein" data-v-5f83224e><button class="${(0, server_renderer_exports.ssrRenderClass)([{ "pill--on": doc.value === "neu" }, "pill"])}" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", doc.value === "neu")} data-v-5f83224e> Neuer Fahrzeugschein </button><button class="${(0, server_renderer_exports.ssrRenderClass)([{ "pill--on": doc.value === "alt" }, "pill"])}" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", doc.value === "alt")} data-v-5f83224e> Alter Fahrzeugschein </button></div>`);
...
var VehicleSelector_default = /*#__PURE__*/ _plugin_vue_export_helper_default(VehicleSelector_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5f83224e"]]);
//#endregion
