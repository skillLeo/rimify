import { a as router, n as link_default, s as vue_exports, t as head_default } from "../ssr.js";
...
var _sfc_setup$1 = FilterBar_vue_vue_type_script_setup_true_lang_default.setup;
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<section class="section-dense" data-v-33a19c50><div class="wrap" data-v-33a19c50><nav class="plp__crumbs t-small" aria-label="Brotkrumen" data-v-33a19c50>`);
			...
			_push(`<span aria-hidden="true" data-v-33a19c50>/</span><span aria-current="page" data-v-33a19c50>Felgen</span></nav><div class="plp__head" data-v-33a19c50><h1 class="t-h1" data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(heading.value)}</h1><p class="plp__count" data-v-33a19c50>`);
			if (__props.total !== null) _push(`<!--[--><strong class="tabular" data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(__props.total)}</strong> ${(0, server_renderer_exports.ssrInterpolate)(__props.total === 1 ? "Felge" : "Felgen")} mit gültigem Gutachten für dieses Fahrzeug <!--]-->`);
			else _push(`<!--[-->${(0, server_renderer_exports.ssrInterpolate)(__props.cards.length)} Felgen im Sortiment<!--]-->`);
			_push(`</p></div>`);
			if (!__props.hasVehicle) {
				_push(`<div class="plp__notice" data-v-33a19c50>`);
				_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
					name: "info",
					size: 20
				}, null, _parent));
				_push(`<p class="plp__notice-text" data-v-33a19c50> Wähle dein Fahrzeug, um nur Felgen zu sehen, die dafür freigegeben sind. </p>`);
			...
			if (__props.hasVehicle) {
				_push(`<div class="plp__bar" data-v-33a19c50><button class="btn btn--secondary plp__bar-btn" type="button" data-v-33a19c50>`);
				_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
					name: "filter",
					size: 20
				}, null, _parent));
				_push(` Filter `);
				if (appliedCount.value > 0) _push(`<span class="plp__bar-n tabular" data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(appliedCount.value)}</span>`);
				else _push(`<!---->`);
				_push(`</button></div>`);
			} else _push(`<!---->`);
			_push(`<div class="${(0, server_renderer_exports.ssrRenderClass)([{ "plp__layout--filters": __props.hasVehicle }, "plp__layout"])}" data-v-33a19c50>`);
			if (__props.hasVehicle) {
				_push(`<aside class="plp__side" aria-label="Filter" data-v-33a19c50>`);
			...
			_push(`<div class="plp__results" data-v-33a19c50>`);
			if (__props.cards.length > 0) {
				_push(`<div class="plp__grid" data-v-33a19c50><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(__props.cards, (card) => {
				...
				_push(`<div class="state" data-v-33a19c50>`);
				_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
					name: "info",
					size: 24
				}, null, _parent));
				_push(`<p class="state__title" data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(appliedCount.value > 0 ? "Keine Felgen für diese Filter." : "Für dieses Fahrzeug haben wir noch keine freigegebenen Felgen.")}</p><p class="t-body" data-v-33a19c50> RIMIFY zeigt ausschließlich Felgen, für die ein gültiges Gutachten vorliegt. </p><div class="cluster" data-v-33a19c50>`);
				if (appliedCount.value > 0) _push(`<button class="btn btn--primary" type="button" data-v-33a19c50> Filter zurücksetzen </button>`);
				else _push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
					href: "/kontakt",
					class: "btn btn--primary"
				}, {
					default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
						if (_push) _push(` Benachrichtigen, sobald verfügbar `);
						else return [(0, vue_exports.createTextVNode)(" Benachrichtigen, sobald verfügbar ")];
					}),
					_: 1
				}, _parent));
				_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
			...
			if (lastPage.value > 1) {
				_push(`<nav class="pager plp__pager" aria-label="Seiten" data-v-33a19c50><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(pages.value, (n) => {
					_push(`<button class="${(0, server_renderer_exports.ssrRenderClass)([{ "pager__page--on": currentPage.value === n }, "pager__page"])}" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-current", currentPage.value === n ? "page" : void 0)} data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(n)}</button>`);
				});
				_push(`<!--]--></nav>`);
			} else _push(`<!---->`);
			_push(`</div></div></div></section>`);
			if (sheetOpen.value) {
				_push(`<!--[--><div class="scrim" data-v-33a19c50></div><div class="sheet plp__sheet" role="dialog" aria-modal="true" aria-label="Filter" data-v-33a19c50><div class="sheet__grab" data-v-33a19c50></div>`);
				_push((0, server_renderer_exports.ssrRenderComponent)(FilterBar_default, {
					facets: __props.facets,
					filters: (0, vue_exports.unref)(filters).current.value,
					total: __props.total,
				...
				_push(`<div class="plp__apply" data-v-33a19c50><button class="btn btn--primary btn--block" type="button" data-v-33a19c50>${(0, server_renderer_exports.ssrInterpolate)(__props.total ?? 0)} ${(0, server_renderer_exports.ssrInterpolate)(__props.total === 1 ? "Felge" : "Felgen")} anzeigen </button></div></div><!--]-->`);
			} else _push(`<!---->`);
			_push(`<!--]-->`);
		};
	}
...
var Index_default = /*#__PURE__*/ _plugin_vue_export_helper_default(Index_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-33a19c50"]]);
//#endregion
