...
import { a as Icon_default, l as isIconName, r as useShared } from "./useShared-B1ZdimaV.js";
import { a as isHsn, i as cleanTsn, o as isTsn, r as cleanHsn, t as DocumentScan_default } from "./DocumentScan-Bap-02t7.js";
import { i as isEqual, n as ProductTileSkeleton_default, r as Accordion_default, t as SpecCallout_default } from "./SpecCallout-Lz4w3dfO.js";
import { B as handleAndDispatchCustomEvent, C as useId$2, D as useBodyScrollLock, F as isClient, H as createContext, I as reactiveOmit, L as refAutoReset, M as useVModel, N as createEventHook, O as injectConfigProviderContext, S as Presence_default, T as useForwardExpose, V as getActiveElement, _ as DismissableLayer_default, b as Primitive, g as FocusScope_default, i as Teleport_default, k as unrefElement, w as useHideOthers } from "./Dialog-DGnwH3Iu.js";
import { t as useDirection } from "./useDirection-CU7rFtRo.js";
import { a as PopperRoot_default, c as useForwardPropsEmits, i as PopperAnchor_default, l as useForwardProps, o as VisuallyHidden_default, r as PopperContent_default, s as useTypeahead, t as AppLayout_default, u as useFocusGuards } from "./AppLayout-BVlt5D4s.js";
import { i as getFocusIntent, o as useCollection, s as usePrimitiveElement } from "./RovingFocusGroup-HJTJn8ZA.js";
...
import { a as Picture_default, i as WheelOutline_default } from "./useShortcuts-DQyB2dUf.js";
import { t as DocFacsimile_default } from "./DocFacsimile-D9bZK4Sy.js";
import { n as VerdictBadge_default } from "./rimify-CDsi0i0x.js";
import { i as withUnit, n as euro, r as felgen, t as decimal } from "./format--h649JLD.js";
...
import { a as komplettrad_illustration_default, d as heroScene, f as rollStyle, i as rimFactsOf, n as TITLE, o as DESKTOP_LAYOUT, p as BrandWall_default, r as RimCode_default, s as HERO_SIZES_DESKTOP, t as DESCRIPTION, u as frameStyle } from "./meta-z-VqHG5m.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-ce2f4e1e><div class="container hero__grid" data-v-ce2f4e1e><div class="hero__copy" data-v-ce2f4e1e><h1 id="h2-title" class="h1 hero__title" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(title.value)}</h1><p class="body-l hero__subline" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(subline.value)}</p>`);
			_push((0, server_renderer_exports.ssrRenderComponent)(HeroSelector_default, {
				selector: __props.selector,
				class: "hero__panel"
			}, null, _parent));
			_push(`</div><div class="hero__stage" style="${(0, server_renderer_exports.ssrRenderStyle)(stageStyle.value)}" data-v-ce2f4e1e>`);
			(0, server_renderer_exports.ssrRenderVNode)(_push, (0, vue_exports.createVNode)((0, vue_exports.resolveDynamicComponent)(linked.value ? "a" : "div"), {
				...
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="hero__frame-box" data-v-ce2f4e1e${_scopeId}><div class="frame hero__frame" data-v-ce2f4e1e${_scopeId}><div class="hero-studio" aria-hidden="true" data-v-ce2f4e1e${_scopeId}></div>`);
						if (photo.value) {
							_push(`<span class="${(0, server_renderer_exports.ssrRenderClass)([{ "hero__roll--rolling": scene.value.roll !== null }, "hero__roll"])}" style="${(0, server_renderer_exports.ssrRenderStyle)(pictureStyle.value)}" data-v-ce2f4e1e${_scopeId}>`);
							if (scene.value.shadow) _push(`<span class="hero-contact" aria-hidden="true" data-v-ce2f4e1e${_scopeId}></span>`);
							else _push(`<!---->`);
							_push(`<span class="hero__spin" data-v-ce2f4e1e${_scopeId}>`);
							...
							_push(`<span class="hero__outline" aria-hidden="true" data-v-ce2f4e1e${_scopeId}>`);
						...
						_push(`<!--]--></div></div>`);
						if (linked.value && product.value) _push(`<span class="hero__caption" data-v-ce2f4e1e${_scopeId}><span class="small hero__caption-name" data-v-ce2f4e1e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(product.value.brand)} ${(0, server_renderer_exports.ssrInterpolate)(product.value.name)} · ${(0, server_renderer_exports.ssrInterpolate)(product.value.finish)}</span><span class="small num muted" data-v-ce2f4e1e${_scopeId}>ab ${(0, server_renderer_exports.ssrInterpolate)(perWheel.value)} · pro Felge</span></span>`);
						else _push(`<!---->`);
						...
						key: 0,
						class: "hero__caption"
					}, [(0, vue_exports.createVNode)("span", { class: "small hero__caption-name" }, (0, vue_exports.toDisplayString)(product.value.brand) + " " + (0, vue_exports.toDisplayString)(product.value.name) + " · " + (0, vue_exports.toDisplayString)(product.value.finish), 1), (0, vue_exports.createVNode)("span", { class: "small num muted" }, "ab " + (0, vue_exports.toDisplayString)(perWheel.value) + " · pro Felge", 1)])) : (0, vue_exports.createCommentVNode)("", true)];
				}),
				_: 1
			}), _parent);
			if (product.value) {
				_push(`<div class="hero__notes" data-v-ce2f4e1e><p class="small num hero__spec" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(product.value.facts.specLine)}`);
				if (kba.value) _push(`<span class="visually-hidden" data-v-ce2f4e1e> · ${(0, server_renderer_exports.ssrInterpolate)(kba.value.label)} ${(0, server_renderer_exports.ssrInterpolate)(kba.value.value)}</span>`);
				else _push(`<!---->`);
				_push(`</p>`);
				if (photo.value) _push(`<span class="micro quiet hero__shown" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(CAPTION)}</span>`);
				else _push(`<span class="micro quiet hero__symbolic" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(SYMBOLIC)}</span>`);
				if ((0, vue_exports.unref)(page).props.demo) _push(`<span class="micro quiet demo-note" data-v-ce2f4e1e>${(0, server_renderer_exports.ssrInterpolate)(DEMO)}</span>`);
				else _push(`<!---->`);
				_push(`</div>`);
			} else _push(`<!---->`);
			_push(`</div></div></section>`);
...
var HomeHero_default = /*#__PURE__*/ _plugin_vue_export_helper_default(HomeHero_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-ce2f4e1e"]]);
//#endregion
