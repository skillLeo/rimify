...
import { r as felgen } from "./format--h649JLD.js";
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (cells.value.length > 0) {
				_push(`<!--[--><ul class="${(0, server_renderer_exports.ssrRenderClass)([{ "brand-wall--flush": __props.flush }, "brand-wall"])}" style="${(0, server_renderer_exports.ssrRenderStyle)(layout.value)}" aria-label="Felgen nach Marke"${(0, server_renderer_exports.ssrRenderAttr)("data-brands", cells.value.length)} data-v-97daf42e><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(cells.value, ({ brand, kind, href }) => {
					_push(`<li class="brand-wall__item" data-v-97daf42e>`);
					(0, server_renderer_exports.ssrRenderVNode)(_push, (0, vue_exports.createVNode)((0, vue_exports.resolveDynamicComponent)(href === null ? "span" : (0, vue_exports.unref)(link_default)), (0, vue_exports.mergeProps)({
						...
						default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
							if (_push) {
								_push(`<span class="brand-cell__stage" data-v-97daf42e${_scopeId}>`);
								if (kind === "mark") _push(`<!--[--><span class="brand-cell__mark" aria-hidden="true" style="${(0, server_renderer_exports.ssrRenderStyle)((0, vue_exports.unref)(markStyle)(brand))}" data-v-97daf42e${_scopeId}></span><span class="visually-hidden" data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(`${brand.name} `)}</span><!--]-->`);
								else if (kind === "sample") _push(`<!--[--><span class="brand-cell__sample" data-v-97daf42e${_scopeId}>Beispiel­sortiment</span><span class="visually-hidden" data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(` (${brand.name}) `)}</span><!--]-->`);
								else _push(`<span class="brand-cell__name"${(0, server_renderer_exports.ssrRenderAttr)("data-len", (0, vue_exports.unref)(wordmarkSize)(brand.name))} data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(brand.name)}</span>`);
								_push(`</span>`);
								if (href !== null) _push(`<span class="brand-cell__foot brand-cell__count small num" data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(felgen)(brand.count))}</span>`);
								else _push(`<span class="brand-cell__foot brand-cell__none small" data-v-97daf42e${_scopeId}><span class="visually-hidden" data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(NO_STOCK_LINE))}</span></span>`);
							...
							}, null, 4), (0, vue_exports.createVNode)("span", { class: "visually-hidden" }, (0, vue_exports.toDisplayString)(`${brand.name} `), 1)], 64)) : kind === "sample" ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)(vue_exports.Fragment, { key: 1 }, [(0, vue_exports.createVNode)("span", { class: "brand-cell__sample" }, "Beispiel­sortiment"), (0, vue_exports.createVNode)("span", { class: "visually-hidden" }, (0, vue_exports.toDisplayString)(` (${brand.name}) `), 1)], 64)) : ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("span", {
								key: 2,
				...
				_push(`<!--]--><li class="brand-wall__item brand-wall__item--all" data-v-97daf42e>`);
				_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
					...
					default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<span class="brand-cell__foot brand-cell__all" data-v-97daf42e${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(closingLabel)(__props.vehicle))}`);
				...
				_push(`</li></ul><p class="small brand-wall__note" data-v-97daf42e>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(noteText)(__props.vehicle, someWithoutStock.value))}</p><!--]-->`);
			} else _push(`<!---->`);
		};
	}
});
...
var BrandWall_default = /*#__PURE__*/ _plugin_vue_export_helper_default(BrandWall_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-97daf42e"]]);
//#endregion
...
function photoHint(key, marked) {
	switch (key) {
		...
		case "et": return "Auf dem Foto nicht zu sehen – die Schnittzeichnung zeigt die Einpresstiefe.";
		...
		case "kba": return marked ? "Markiert: die KBA-Nummer auf dem Rad." : "Auf dem Foto nicht markiert.";
	}
}
...
var RimCodePhoto_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue_exports.defineComponent)({
	...
	setup(__props) {
		...
		*/
		...
		const hint = (0, vue_exports.computed)(() => photoHint(props.active, shape.value !== null));
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<figure${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "rc-photo" }, _attrs))} data-v-f69d3c87><div class="rc-photo__frame" style="${(0, server_renderer_exports.ssrRenderStyle)({ aspectRatio: ratio.value })}" data-v-f69d3c87>`);
			...
			_push(`<svg class="rc-photo__overlay"${(0, server_renderer_exports.ssrRenderAttr)("viewBox", box.value)} preserveAspectRatio="none" aria-hidden="true" focusable="false" data-v-f69d3c87>`);
			if (shape.value?.kind === "circle") _push(`<circle class="${(0, server_renderer_exports.ssrRenderClass)([{ "rc-photo__shape--dashed": shape.value.dashed }, "rc-photo__shape"])}"${(0, server_renderer_exports.ssrRenderAttr)("data-shape", shape.value.key)}${(0, server_renderer_exports.ssrRenderAttr)("cx", shape.value.cx)}${(0, server_renderer_exports.ssrRenderAttr)("cy", shape.value.cy)}${(0, server_renderer_exports.ssrRenderAttr)("r", shape.value.r)} data-v-f69d3c87></circle>`);
			else if (shape.value?.kind === "rect") _push(`<rect class="rc-photo__shape"${(0, server_renderer_exports.ssrRenderAttr)("data-shape", shape.value.key)}${(0, server_renderer_exports.ssrRenderAttr)("x", shape.value.x)}${(0, server_renderer_exports.ssrRenderAttr)("y", shape.value.y)}${(0, server_renderer_exports.ssrRenderAttr)("width", shape.value.width)}${(0, server_renderer_exports.ssrRenderAttr)("height", shape.value.height)} data-v-f69d3c87></rect>`);
			else _push(`<!---->`);
			_push(`</svg>`);
			if (label.value) _push(`<span class="rc-photo__label small num" style="${(0, server_renderer_exports.ssrRenderStyle)(labelStyle.value)}" aria-hidden="true" data-v-f69d3c87>${(0, server_renderer_exports.ssrInterpolate)(label.value.text)}</span>`);
			else _push(`<!---->`);
			_push(`</div><figcaption class="rc-photo__caption" data-v-f69d3c87><span class="small muted rc-photo__hint" data-v-f69d3c87>${(0, server_renderer_exports.ssrInterpolate)(hint.value)}</span>`);
			if (__props.credit) _push(`<span class="micro quiet" data-v-f69d3c87>${(0, server_renderer_exports.ssrInterpolate)(__props.credit)}</span>`);
			else _push(`<!---->`);
...
var RimCodePhoto_default = /*#__PURE__*/ _plugin_vue_export_helper_default(RimCodePhoto_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-f69d3c87"]]);
//#endregion
...
var RimCodeSchematic_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue_exports.defineComponent)({
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<figure${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "rc-sch" }, _attrs))} data-v-2b0d50a4><div class="rc-sch__sides micro muted" data-v-2b0d50a4><span data-side="inside" data-v-2b0d50a4>← zur Fahrzeugmitte</span><span data-side="outside" data-v-2b0d50a4>nach außen (Kotflügel) →</span></div><svg class="rc-sch__svg"${(0, server_renderer_exports.ssrRenderAttr)("viewBox", `0 0 ${(0, vue_exports.unref)(SCHEMATIC).width} ${(0, vue_exports.unref)(SCHEMATIC).height}`)}${(0, server_renderer_exports.ssrRenderAttr)("width", (0, vue_exports.unref)(SCHEMATIC).width)}${(0, server_renderer_exports.ssrRenderAttr)("height", (0, vue_exports.unref)(SCHEMATIC).height)} role="img"${(0, server_renderer_exports.ssrRenderAttr)("aria-label", description.value)} focusable="false" data-v-2b0d50a4><defs data-v-2b0d50a4><pattern${(0, server_renderer_exports.ssrRenderAttr)("id", hatch)} patternUnits="userSpaceOnUse" width="6" height="6" patternTransform="rotate(45)" data-v-2b0d50a4><path class="rc-sch__hatch" d="M 0 0 L 0 6" data-v-2b0d50a4></path></pattern></defs><path class="rc-sch__axis" data-part="axis"${(0, server_renderer_exports.ssrRenderAttr)("d", (0, vue_exports.unref)(WHEEL_AXIS))} data-v-2b0d50a4></path><path class="${(0, server_renderer_exports.ssrRenderClass)([{ "is-active": traced.value === "lk" }, "rc-sch__axis"])}" data-part="bolt-axis"${(0, server_renderer_exports.ssrRenderAttr)("d", (0, vue_exports.unref)(BOLT_AXIS))} data-v-2b0d50a4></path><path class="rc-sch__cut" data-part="profile"${(0, server_renderer_exports.ssrRenderAttr)("d", (0, vue_exports.unref)(PROFILE))}${(0, server_renderer_exports.ssrRenderAttr)("fill", `url(#${hatch})`)} data-v-2b0d50a4></path><path class="rc-sch__cut" data-part="pad-below"${(0, server_renderer_exports.ssrRenderAttr)("d", (0, vue_exports.unref)(PAD_BELOW))}${(0, server_renderer_exports.ssrRenderAttr)("fill", `url(#${hatch})`)} data-v-2b0d50a4></path><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)([(0, vue_exports.unref)(SCHEMATIC).xFlangeIn, (0, vue_exports.unref)(SCHEMATIC).xFlangeOut], (x) => {
				_push(`<line class="rc-sch__ref" data-part="flange-face"${(0, server_renderer_exports.ssrRenderAttr)("x1", x)}${(0, server_renderer_exports.ssrRenderAttr)("y1", 54)}${(0, server_renderer_exports.ssrRenderAttr)("x2", x)}${(0, server_renderer_exports.ssrRenderAttr)("y2", (0, vue_exports.unref)(SCHEMATIC).yBeadSeat)} data-v-2b0d50a4></line>`);
			});
			_push(`<!--]--><line class="rc-sch__ref" data-part="anlage"${(0, server_renderer_exports.ssrRenderAttr)("x1", (0, vue_exports.unref)(SCHEMATIC).xAnlage)}${(0, server_renderer_exports.ssrRenderAttr)("y1", (0, vue_exports.unref)(SCHEMATIC).yPadTop)}${(0, server_renderer_exports.ssrRenderAttr)("x2", (0, vue_exports.unref)(SCHEMATIC).xAnlage)}${(0, server_renderer_exports.ssrRenderAttr)("y2", (0, vue_exports.unref)(SCHEMATIC).yBore)} data-v-2b0d50a4></line><line class="${(0, server_renderer_exports.ssrRenderClass)([{ "is-active": traced.value === "et" }, "rc-sch__centre"])}" data-part="centre-plane"${(0, server_renderer_exports.ssrRenderAttr)("x1", (0, vue_exports.unref)(CENTRE_PLANE).x)}${(0, server_renderer_exports.ssrRenderAttr)("y1", (0, vue_exports.unref)(CENTRE_PLANE).y1)}${(0, server_renderer_exports.ssrRenderAttr)("x2", (0, vue_exports.unref)(CENTRE_PLANE).x)}${(0, server_renderer_exports.ssrRenderAttr)("y2", (0, vue_exports.unref)(CENTRE_PLANE).y2)} data-v-2b0d50a4></line><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)(dimensions.value, (dim) => {
				_push(`<g class="${(0, server_renderer_exports.ssrRenderClass)([{ "is-active": traced.value === dim.key }, "rc-sch__dim"])}"${(0, server_renderer_exports.ssrRenderAttr)("data-dim", dim.key)} data-v-2b0d50a4><path class="rc-sch__ext"${(0, server_renderer_exports.ssrRenderAttr)("d", dim.ext)} data-v-2b0d50a4></path><path class="rc-sch__line" data-role="line"${(0, server_renderer_exports.ssrRenderAttr)("d", dim.line)} data-v-2b0d50a4></path><path class="rc-sch__line"${(0, server_renderer_exports.ssrRenderAttr)("d", dim.ticks)} data-v-2b0d50a4></path>`);
				if (traced.value === dim.key) _push(`<path class="rc-sch__face" data-role="faces"${(0, server_renderer_exports.ssrRenderAttr)("d", dim.faces)} data-v-2b0d50a4></path>`);
				else _push(`<!---->`);
				_push(`<text class="rc-sch__label num"${(0, server_renderer_exports.ssrRenderAttr)("x", dim.label.x)}${(0, server_renderer_exports.ssrRenderAttr)("y", dim.label.y)}${(0, server_renderer_exports.ssrRenderAttr)("text-anchor", dim.label.anchor)}${(0, server_renderer_exports.ssrRenderAttr)("transform", (0, vue_exports.unref)(labelTransform)(dim.label))} data-v-2b0d50a4>${(0, server_renderer_exports.ssrInterpolate)(dim.label.text)}</text></g>`);
			});
			_push(`<!--]--><!--[-->`);
			(0, server_renderer_exports.ssrRenderList)((0, vue_exports.unref)(PARTS), (part) => {
				_push(`<g class="${(0, server_renderer_exports.ssrRenderClass)([{ "is-active": traced.value !== null && part.for.includes(traced.value) }, "rc-sch__part"])}"${(0, server_renderer_exports.ssrRenderAttr)("data-part-label", part.id)} data-v-2b0d50a4>`);
				if (part.leader) _push(`<path class="rc-sch__leader"${(0, server_renderer_exports.ssrRenderAttr)("d", part.leader)} data-v-2b0d50a4></path>`);
				else _push(`<!---->`);
				_push(`<text class="rc-sch__label"${(0, server_renderer_exports.ssrRenderAttr)("x", part.label.x)}${(0, server_renderer_exports.ssrRenderAttr)("y", part.label.y)}${(0, server_renderer_exports.ssrRenderAttr)("text-anchor", part.label.anchor)} data-v-2b0d50a4>${(0, server_renderer_exports.ssrInterpolate)(part.label.text)}</text></g>`);
			});
			_push(`<!--]--></svg><figcaption class="micro quiet rc-sch__caption" data-v-2b0d50a4>Schnittzeichnung, schematisch, nicht maßstäblich.</figcaption></figure>`);
		};
	}
});
//#endregion
...
var RimCodeSchematic_default = /*#__PURE__*/ _plugin_vue_export_helper_default(RimCodeSchematic_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-2b0d50a4"]]);
//#endregion
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			if (tokens.value.length && shownToken.value) {
				_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: ["rc", [`rc--${__props.layout}`, { "rc--no-photo": !frame.value }]] }, _attrs))} data-v-313f2281><div class="rc__tokens" role="group" aria-label="Werte der Felge" data-v-313f2281><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(tokens.value, (token, i) => {
					_push(`<button class="${(0, server_renderer_exports.ssrRenderClass)([{ "is-shown": token.key === shown.value }, "chip rc-token"])}" type="button"${(0, server_renderer_exports.ssrRenderAttr)("aria-pressed", token.key === committed.value ? "true" : "false")}${(0, server_renderer_exports.ssrRenderAttr)("data-token", token.key)} data-v-313f2281><span class="visually-hidden" data-v-313f2281>${(0, server_renderer_exports.ssrInterpolate)(token.term)}: </span><span class="rc-token__value num" data-v-313f2281>${(0, server_renderer_exports.ssrInterpolate)(token.text)}</span></button>`);
				});
				_push(`<!--]--></div>`);
				...
				_push(`<div class="rc__def" aria-live="polite" data-v-313f2281><p class="label rc__term" data-v-313f2281>${(0, server_renderer_exports.ssrInterpolate)(shownToken.value.term)}</p><p class="body-l rc__sentence" data-role="definition" data-v-313f2281>${(0, server_renderer_exports.ssrInterpolate)(shownToken.value.sentence)}</p></div>`);
...
var RimCode_default = /*#__PURE__*/ _plugin_vue_export_helper_default(RimCode_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-313f2281"]]);
//#endregion
