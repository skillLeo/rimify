	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "adm" }, _attrs))} data-v-5b3e0d64><aside class="adm__side" data-v-5b3e0d64>`);
			...
			_push(`<!--]--><div class="adm__spacer" data-v-5b3e0d64></div><button class="adm__link adm__link--button" type="button" data-v-5b3e0d64>`);
			_push((0, server_renderer_exports.ssrRenderComponent)(Icon_default, {
				name: "settings",
				size: 20
			}, null, _parent));
			_push(` ${(0, server_renderer_exports.ssrInterpolate)(theme.value === "dark" ? "Helles Design" : "Dunkles Design")}</button></aside><main class="adm__main" data-v-5b3e0d64><div class="adm__topbar" data-v-5b3e0d64>`);
			if (__props.title) _push(`<h1 class="t-h2 adm__title" data-v-5b3e0d64>${(0, server_renderer_exports.ssrInterpolate)(__props.title)}</h1>`);
			else _push(`<!---->`);
			_push(`</div>`);
...
var AdminLayout_default = /*#__PURE__*/ _plugin_vue_export_helper_default(AdminLayout_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-5b3e0d64"]]);
//#endregion
