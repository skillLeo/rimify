...
import "./useShared-CY71KcPZ.js";
import { a as Picture_default, i as WheelOutline_default, r as useCompare } from "./useShortcuts-XJHE0tId.js";
import { S as euro, T as zoll, t as ValueText_default } from "./ValueText-CkuszrcW.js";
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			}, _attrs))} data-v-0f0730f4><div class="tile__media" data-v-0f0730f4>`);
			...
			_push(`</div><span class="tile__brand" translate="no" data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(__props.card.brandName)}</span><h3 class="tile__title" data-v-0f0730f4><span class="tile__name" translate="no" data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(__props.card.modelName)}</span></h3><span class="tile__meta" data-v-0f0730f4><span class="tile__finish" translate="no" data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(__props.card.finishName)}</span>`);
			if (__props.card.diameters.length) _push(`<span class="tile__sep" aria-hidden="true" data-v-0f0730f4> · </span>`);
			else _push(`<!---->`);
			if (sizedByVehicle.value && __props.card.diameters.length) {
				_push(`<span class="tile__sizes num" translate="no" data-v-0f0730f4><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(sizeList.value, (size, i) => {
					_push(`<!--[-->${(0, server_renderer_exports.ssrInterpolate)(i > 0 ? " · " : "")}<span class="${(0, server_renderer_exports.ssrRenderClass)({ "tile__size--none": size.none })}" data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(size.label)}`);
					if (size.none) _push(`<span class="visually-hidden" translate="yes" data-v-0f0730f4> (keine Freigabe für dein Fahrzeug)</span>`);
					else _push(`<!---->`);
					_push(`</span><!--]-->`);
				});
				_push(`<!--]-->${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(" "))}Zoll</span>`);
			} else if (sizesPlain.value) _push(`<span class="tile__sizes num" translate="no" data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(sizesPlain.value)}</span>`);
			else _push(`<!---->`);
			_push(`</span><p class="tile__price" data-v-0f0730f4>ab `);
			_push((0, server_renderer_exports.ssrRenderComponent)(ValueText_default, {
				text: perWheel.value,
				whole: ""
			}, null, _parent));
			_push(` <small data-v-0f0730f4>pro Felge</small></p><span class="tile__legal" data-v-0f0730f4>inkl. MwSt., zzgl. Versand</span>`);
			if (verdict.value && verdict.value.conditions.length) {
				_push(`<ul class="tile__conditions" data-v-0f0730f4><!--[-->`);
				(0, server_renderer_exports.ssrRenderList)(verdict.value.conditions, (condition) => {
					_push(`<li data-v-0f0730f4>${(0, server_renderer_exports.ssrInterpolate)(condition)}</li>`);
				});
				_push(`<!--]--></ul>`);
			} else _push(`<!---->`);
			if (!__props.card.inStock) _push(`<span class="stock stock--out" data-v-0f0730f4>Ausverkauft</span>`);
			else _push(`<!---->`);
			_push(`<div class="tile__actions" data-v-0f0730f4>`);
			...
			if (__props.compare) _push(`<label class="${(0, server_renderer_exports.ssrRenderClass)([{ "tile__compare--full": capped.value }, "tile__compare"])}" data-v-0f0730f4><input type="checkbox" class="tile__compare-input" name="vergleich"${(0, server_renderer_exports.ssrRenderAttr)("value", key.value)}${(0, server_renderer_exports.ssrIncludeBooleanAttr)(inCompare.value) ? " checked" : ""}${(0, server_renderer_exports.ssrIncludeBooleanAttr)(capped.value) ? " disabled" : ""}${(0, server_renderer_exports.ssrRenderAttr)("aria-label", `${fullName.value} vergleichen`)} data-v-0f0730f4> Vergleichen </label>`);
			else _push(`<!---->`);
			_push(`</div></article>`);
		};
	}
...
var ProductTile_default = /*#__PURE__*/ _plugin_vue_export_helper_default(ProductTile_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-0f0730f4"]]);
//#endregion
