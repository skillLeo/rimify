 ...
 * verified load rating adds a "Traglast" row; and the main photograph opens large in a dialog that
 * Escape closes.
 */
...
vi.mock('@inertiajs/vue3', () => ({
    ...
    useForm: <T extends object>(data: T) =>
        reactive({ ...data, processing: false, post: (...args: unknown[]) => post(...args) }),
}))
