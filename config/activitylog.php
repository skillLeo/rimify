...
return [
     ...
     */
    // The build calls this table `audit_logs`; this package version hard-codes `activity_log` and
    // no longer offers a table_name key, so the name lives on the model instead.
